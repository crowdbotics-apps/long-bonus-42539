"""
Django settings for long_bonus_42539 project.
...
ROOT_URLCONF = 'long_bonus_42539.urls'
...
WSGI_APPLICATION = 'long_bonus_42539.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "long_bonus_42539 API",
    "DESCRIPTION": "API documentation for long_bonus_42539 App",
    "VERSION": "v1",
}
